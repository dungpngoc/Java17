...
public class DateTime {
    public static void main(String[] args) {
        // Khởi tạo đối tượng và sử dụng method LocalTime.now() để lấy ra giờ phút giây hiện tại
        LocalTime localTime = LocalTime.now();
//        System.out.println(localTime);
//        // LocalTimeof nếu muốn chỉ định giờ phút giây
...
//        System.out.println(localTime1);
        ...
        LocalTime lt3 = LocalTime.now().plusHours(2);
