...
//        String name = "Phạm Ngọc Dũng";
//        int age = 28;
//        String sex = "Nam";
//        String address = "Hà Nội";
//        String interets = "chơi thể thao";
//        System.out.println("Mình tên là "+ name + ",năm nay " + age +" tuổi " + ",giới tính " + sex +
//                ", hiện tại đang sinh sống và làm việc tại " + address + ", sở thích của tôi là " + interets);
        }
    }
