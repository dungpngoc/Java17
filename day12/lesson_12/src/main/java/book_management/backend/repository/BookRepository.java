...
public class BookRepository {
    // Lấy ra tất cả các quyển sách trong DB ( chỉ có repo mới thao tác với database)
    public List<Book> findAll() {
        return BookDB.books;
    }

    // Nếu có id = id ng dùng nhập thì trả về return, không thì sẽ ném ra notfoundexception vừa định nghĩa
